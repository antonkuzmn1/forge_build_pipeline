...
public final class ModItems {
    ...
    public static final RegistryObject<Item> UNLIT_CAMPFIRE = ExampleMod.ITEMS.register("unlit_campfire", () -> new BlockItem(ModBlocks.UNLIT_CAMPFIRE.get(), new Item.Properties()));
